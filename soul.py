...
BOT_TOKEN = "7419578096:AAHu1pUhz8bmto-Yf-8CwtiN9MJDzdOPG0I"
CHANNEL_ID = ["-1002389821535", "-1002313389888"]
...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if not await is_user_in_all_channels(user_id, context):
        await update.message.reply_text(
            ...
            "2. [Channel 2](https://t.me/+77OkjGOfoOwzNjE1)",
            parse_mode="Markdown",
        )
    else:
        await update.message.reply_text("✅ Welcome! Use /bgmi to start. OWNER @SHADOW_OFFICIAL11")
